...
\<pre\>\<code\>{
  ...
  "[contact.name](http://contact.name)": "Jierson",
...
\<pre\>\<code\>{
  ...
  "email": "[jiersonj@gmail.com](mailto:jiersonj@gmail.com)",
...
\<pre\>\<code\>{
  ...
  "email": "[daniel.fernandez@botslovers.com](mailto:daniel.fernandez@botslovers.com)"
