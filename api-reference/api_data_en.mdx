...
> Note: The `query` parameter must be URL-encoded.
...
> ⚠️ These records have not been anonymized or pseudonymized to preserve the full context of each conversation and ensure analysis accuracy.
