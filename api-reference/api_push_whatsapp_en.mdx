...
<blockquote>📌 Important: Save this token — you'll use it to interact with the rest of the API.</blockquote>
...
<blockquote>📝 Each company will have a unique access key. You must use the correct key depending on which company you're interacting with.</blockquote>
...
<h2>🔊 Upload Audio</h2>
<p>POST to:</p>
<pre><code>https://cloud.lovi.ai/functions/v1/voice/upload</code></pre>
...
<blockquote>✍️ This documentation is auto-generated based on Postman collection for Botslovers & LOVI ecosystem. For any questions, contact your API administrator.</blockquote>
