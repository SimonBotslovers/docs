...
These placeholders will be replaced with the corresponding values provided in the request payload. The system will look for parameters that match the placeholder name — either from the `contact` object or from any other custom parameter.
